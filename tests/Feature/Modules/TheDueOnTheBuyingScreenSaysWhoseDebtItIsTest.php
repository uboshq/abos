...
class TheDueOnTheBuyingScreenSaysWhoseDebtItIsTest extends TestCase
{
    ...
    public function test_the_totals_card_keeps_the_three_debts_apart(): void
    {
         ...
         *
         * ⚠️ তাই এখন ঘরটাসহ খোঁজা হয় — `>লেখা</`। মন্তব্যের ভেতরের লেখা
         * কোনোদিন একটা বন্ধ ট্যাগ নিয়ে আসে না।
         *
         * ── ⓘ কেন ট্যাগের **নাম** ধরা হয় না (৬ সেপ্টেম্বর ২০২৬) ────────
         * আগে `</span>` লেখা ছিল, আর তাতে পরীক্ষাটা মার্কআপের ছাঁচ ঠিক
         * করে দিত: মোটের কার্ডটা একটা definition list, তাই লেবেলটা
         * `<dt>`-এ বসে (`total_due` `<span>`-এ, কারণ ওটা যোগফলের সারি)।
         * ⛔ দুইটাই ঠিক, অথচ একটা লাল হত — অর্থাৎ পরীক্ষাটা যা পাহারা
         * দিতে বসেছে (**লেবেলটা সত্যিই আঁকা হয়েছে কি না**) তার বদলে
         * ট্যাগের নাম পাহারা দিচ্ছিল।
         *
         * ⭐ বন্ধ-ট্যাগের `</`-টুকুই আসল শর্ত, আর সেটা অক্ষত।
         */
