...
class TheBuyingCounterLooksLikeTheOwnerDrewItTest extends TestCase
{
    ...
    /**
     * ⚠️ মালটা গুদামে ঢোকে, কিন্তু তাকে নয় — আর পর্দা সেটা বলে।
     *
     * ⛔ কথাটা না থাকলে সবুজ নিশ্চিতকরণটা *"তাকে উঠে গেছে"* পড়া যেত, আর
     * ওই ঘণ্টাতেই মালটা বিক্রি হয়ে যেত — যেটা এখনো বিক্রয়যোগ্যই নয়।
     */
    public function test_the_screen_says_the_goods_are_not_on_a_shelf_yet(): void
    {
        $this->assertScreenSays($this->screen(), 'purchase::message.goods_wait_for_placement');
    }
