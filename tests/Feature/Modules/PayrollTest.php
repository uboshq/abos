...
class PayrollTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        /*
         * ⓘ এই পরীক্ষাগুলো "বেতনের তালিকায় সবাই" বলতে বোঝায় **নিজের
         * বানানো** কর্মীদের — দুইজন বানালে দুইটা পাতা, কেউ না থাকলে রান
         * প্রত্যাখ্যাত।
         *
         * ⛔ ১৪ সেপ্টেম্বর ২০২৬ থেকে (608ceaa9) ডেমো-সিডার মালিকের নিজের
         * কর্মী-রেকর্ড বানায় (`EMP-0001`, ফুটারে পদবি দেখাতে)। ফলে প্রতিটা
         * রানে একটা বাড়তি পাতা বসত, আর ছয়টা পরীক্ষা "৩ বনাম ২"-এ লাল হয়ে
         * ছিল — কারও কোড ভাঙেনি, কেবল অনুমানটা পুরনো হয়েছিল।
         *
         * ⚠️ সিডার থেকে কর্মীটা সরানো হয়নি, কারণ তাহলে ডেমোর বেতনের পর্দা
         * খালি দেখাত। ⓘ বদলে পরীক্ষা নিজের শুরুতে তাঁকে তালিকা থেকে সরায়।
         */
