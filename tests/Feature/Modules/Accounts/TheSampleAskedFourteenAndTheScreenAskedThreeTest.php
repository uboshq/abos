...
final class TheSampleAskedFourteenAndTheScreenAskedThreeTest extends TestCase
{
    ...
    private const PARTY = [
        ...
        /*
         * ⛔ 'carried_by' ও 'moved_at' এখানে ছিল — মালিকের সিদ্ধান্তে
         * বাদ, ১৫ সেপ্টেম্বর ২০২৬।
         *
         * ⓘ নমুনায় ঘর দুইটা আছে, কিন্তু গুনে দেখা গেল **কেউ ওগুলো
         * পড়ে না** — মাইগ্রেশন, fillable, ভ্যালিডেশন আর ফর্ম ছাড়া
         * একটাও পর্দা বা রিপোর্ট ছোঁয় না।
         *
         * ⚠️ তাই তালিকাটা এখন নমুনার হুবহু নকল নয়, **মালিকের চূড়ান্ত
         * সিদ্ধান্তের** নকল — আর সেটাই সঠিক: নমুনা একটা প্রস্তাব,
         * তাঁর কথাটা রায়।
         *
         * ⓘ কন্ট্রায় `carried_by` থেকে যাচ্ছে ("কে হাতে নিয়ে গেল"),
         * তাই কলামটা মুছছে না — কেবল এই দুই পর্দা থেকে সরেছে।
         */
