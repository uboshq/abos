...
class MoneyTest extends TestCase
{
    ...
    public static function amounts(): array
    {
        return [
            ...
            /*
             * ⛔ লাখ-কোটির কমা — ২১ সেপ্টেম্বর ২০২৬।
             *
             * ⓘ নাম দুইটা শুরু থেকেই "লাখ" আর "কোটি" বলত, অথচ
             * মান দুইটা হাজারের নিয়মে লেখা ছিল — পরীক্ষাটা নিজেই
             * দুই ভাষায় কথা বলত।
             */
            'লাখ' => ['125000.5', '1,25,000.50'],
            'কোটি' => ['12345678.9', '1,23,45,678.90'],

            /* ⚠️ সীমানার দুইটা: তিন অঙ্কে কমা নেই, চারে একটা */
            'তিন অঙ্কের নিচে কমা নেই' => ['999.999', '1,000.00'],
            'চার অঙ্কে একটা কমা' => ['1000', '1,000.00'],
            'পাঁচ অঙ্কেও একটাই' => ['99999', '99,999.00'],
            'ছয় অঙ্কে দুইটা' => ['100000', '1,00,000.00'],
