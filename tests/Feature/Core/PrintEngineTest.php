...
class PrintEngineTest extends TestCase
{
    ...
    private function voucher(): array
    {
        return [
            ...
            /*
             * সইয়ের ঘরগুলো — আদায়ের রসিদে যা বসে।
             *
             * টেমপ্লেট এটা না পেলে ভেঙে পড়ে, আর সেটাই কাম্য: আগে সে
             * নিজেই তিনটা নাম বানিয়ে নিত, ফলে জাবেদার কাগজেও "গ্রহণ
             * করলেন" ছাপা হত। ডিফল্ট রাখলে ভুলে যাওয়া ডাকটা চুপচাপ
             * সইয়ের ঘর ছাড়া একটা কাগজ ছাপত — আর টাকার কাগজে ওটা
             * চোখে পড়ার আগেই হাতবদল হয়ে যায়।
             *
             * ক্রম: প্রথমে অপর পক্ষ, তারপর অফিসের দুইজন। তাপীয় কাগজে
             * শুধু প্রথমটা থাকে (VoucherPrintTest ওটা পাহারা দেয়)।
             */
            'signatures' => ['প্রদানকারীর স্বাক্ষর', 'প্রস্তুতকারী', 'অনুমোদনকারী'],
