...
class ModuleMenuTest extends TestCase
{
    ...
    public function test_planned_items_are_shown_but_never_lead_anywhere(): void
    {
        ...
        /*
         * ── তালিকাটা সত্যিই ভরেছে তো ─────────────────────────────────
         * নিচের দাবিগুলো `$planned` খালি হলে **আপনাআপনি সত্য** —
         * খালি তালিকার সব সারিই শর্ত মানে, আর `array_diff` খালি ফেরে।
         * অর্থাৎ চাবিটার নাম একদিন বদলালে বা module.php-র গঠন বদলালে
         * পরীক্ষাটা নীরবে অর্থহীন হয়ে সবুজ থাকত।
         *
         * ⚠️ এই রিপোতে ঠিক এই আকারের ভুল আগে তিনবার ধরা পড়েছে — একটা
         * ছাড় যা অরক্ষিত রুট দেখেও ছেড়ে দিত, একটা পাহারা যা ৪% ফাইল
         * দেখত, আর একটা গণনা যা "নেই" আর "দেখা যাচ্ছে না" মেলাত।
         * তিনটাই সবুজ ছিল আর কিছুই দেখত না।
         */
        $this->assertNotEmpty($planned,
            "module.php-তে একটাও 'planned' => true সারি পাওয়া যায়নি। "
            .'সত্যিই সব স্ক্রিন তৈরি হয়ে থাকলে এই পরীক্ষাটাই আর দরকার নেই; '
            .'নাহলে চাবিটা পড়া বন্ধ হয়ে গেছে, আর নিচের দাবিগুলো এখন ফাঁকা।');
