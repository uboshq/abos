...
class NumberSeriesTest extends TestCase
{
    ...
    public function test_a_document_type_added_after_the_company_still_gets_a_number(): void
    {
        ...
        /*
         * ⚠️ আগে এখানে `'2026-2027'` খোঁজা হত — অর্থবছরটা নম্বরে আছে কি না।
         *
         * ⛔ ছকটা বদলেছে, ৫ সেপ্টেম্বর ২০২৬: মালিকের সিদ্ধান্ত
         * *"Document number series {PREFIX}-{SEQ} বাই ডিফল্ট বসাও"*। ⓘ তাই
         * ডিফল্ট নম্বরে বছর নেই, আর পুরনো দাবিটা **কোডের ভুল ধরত না, নিজের
         * পুরনোত্ব ধরত**।
         *
         * ⭐ এই পরীক্ষাটার আসল প্রশ্নটা বছর নিয়ে নয়: *"কোম্পানি তৈরির পরে
         * যোগ হওয়া একটা ধরনও কি নম্বর পায়?"* ⓘ তাই দাবিটা এখন সেটাই মাপে —
         * নম্বরটা উপসর্গ ধরে শুরু হয়, আর সিরিজের সারিটা নিজে থেকে বসে।
         */
        $this->assertStringStartsWith('LN-', $no);
