...
class TheMenuStandsInTheOrderTheOwnerAskedForTest extends TestCase
{
    ...
    private const AS_HE_ASKED = [
         ...
         */
        /*
         * ⭐ মালের পথ ধরে — মালিকের সিদ্ধান্ত, ৫ সেপ্টেম্বর ২০২৬:
         * *"সরবরাহকারী · ক্রয় · মজুদ · গ্রাহক · বিক্রয় · রেস্টুরেন্ট
         * এইভাবে বসাবে।"*
         *
         * ⓘ সরবরাহকারী মাল দেন → আমরা কিনি → গুদামে ঢোকে → গ্রাহক আসেন
         * → বিক্রি হয়। ⚠️ আগে গ্রাহক সবার আগে বসত; কিন্তু কাগজের দিক
         * থেকে তিনি আসেন **মাল আসার পরে**, আর ডিপোর দিনটাও শুরু হয়
         * গাড়ি দিয়ে। ⭐ ক্রমটাই নতুন কর্মীকে ব্যবসাটা শিখিয়ে দেয়।
         */
        ['business', 'supplier'],
        ['business', 'purchase'],
        ['business', 'inventory'],
