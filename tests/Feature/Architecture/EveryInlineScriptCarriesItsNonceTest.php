...
final class EveryInlineScriptCarriesItsNonceTest extends TestCase
{
    ...
    public function test_no_inline_block_is_missing_its_nonce(): void
    {
        ...
        /*
         * ⚠️ মেঝেটা ১২ থেকে ৫-এ নামানো, ২০ সেপ্টেম্বর ২০২৬।
         *
         * ⓘ কারণটা ভালো: 9b93cc03 ইনলাইন স্ক্রিপ্টগুলো সরিয়ে `unsafe-eval`
         * বাদ দিয়েছে, তাই ব্লক কমাটাই প্রত্যাশিত ছিল। ⛔ তবু মেঝেটা থাকে,
         * কারণ এই দাবির আসল কাজ ব্লক গোনা নয় — **খোঁজাটা নিজে ভেঙে গেছে
         * কি না** সেটা ধরা। শূন্য ব্লক পেলে নিচের দাবিগুলো নীরবে পাস করত।
         */
        $this->assertGreaterThanOrEqual(5, $blocks, implode("\n", [
            'ইনলাইন ব্লক পাওয়া গেল '.$blocks.'টা, অথচ ২০ সেপ্টেম্বর ২০২৬-এ',
            'মেপে পাওয়া গিয়েছিল ৫টা।',
            '',
            '⚠️ কমে যাওয়া মানে হয় ব্লকগুলো সরানো হয়েছে (ভালো — তখন এই',
            'সংখ্যাটাও নামিয়ে দিন, কারণসহ), নয়তো এই পাহারার খোঁজাটা আর',
            'ওদের চিনতে পারছে না (খারাপ, আর নীরব)।',
        ]));
