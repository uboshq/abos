...
class AClassTheBundleNeverHeardOfDoesNothingTest extends TestCase
{
    ...
    private const STALE = [
        /*
         * ⛔ এটার কাজ ছিল ছাপার সময় লুকানো, আর সে কিছুই লুকায় না।
         * ⓘ ছাপার নিজের পাতাগুলো খোলস ব্যবহার করে না, তাই সেখানে সমস্যা
         * নেই — কিন্তু কেউ পর্দা থেকে সরাসরি Ctrl+P করলে নিচের নেভিগেশন
         * আর প্রসেস-ব্যান্ড কাগজে ছাপা হয়।
         */
        'no-print' => 'ছাপায় লুকানোর শ্রেণি, বান্ডিলে নেই — বিল্ড লাগবে (ছাপার কাজ abos-77-এর)',

        // ⓘ কোনো নিয়মই নেই, তিন পাতায় লেখা — সম্ভবত পুরনো নকশার অবশেষ
        'shell' => 'কোনো সংজ্ঞা নেই, উৎসেও না — মৃত অবশেষ, যিনি পর্দাটার মালিক তিনি তুলে দেবেন',

        // ⓘ বড় পর্দার সাজসজ্জা; না থাকলে ছোট ব্রেকপয়েন্টেই পড়ে থাকে
        '2xl:grid-cols-3' => 'বান্ডিলে `2xl:` ব্রেকপয়েন্টের এই সারিটা নেই — বিল্ড লাগবে',
        '2xl:grid-cols-[1fr_27rem]' => 'একই কারণ',
    ];
