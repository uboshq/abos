...
class NoLeakedBladeTest extends TestCase
{
    ...
    private const LEAKS = [
        ...
        /*
         * ⛔ হুবহু ছাপা কম্পোনেন্ট ট্যাগ — ২১ সেপ্টেম্বর ২০২৬।
         *
         * ⚠️ উপরের চিহ্নগুলো সবই PHP অ্যারের টুকরা, তাই একটা ট্যাগ যদি
         * কেবল নিজের অ্যাট্রিবিউট নিয়ে ছাপা হয় (`<x-ui.select :name="$field" …>`)
         * তাদের একটাও মেলে না। ⓘ ব্রাউজার ওটাকে অচেনা এলিমেন্ট ধরে
         * চুপচাপ আঁকে — পাতা ২০০ দেয়, আর ঘরটা কেবল **থাকে না**।
         *
         * ⓘ পাতায় `<x-` কাঁচা অবস্থায় থাকার কোনো বৈধ কারণ নেই; দেখানোর
         * জন্য লিখলে সেটা `&lt;x-` হয়ে যেত।
         */
        '<x-',
    ];
