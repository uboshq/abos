...
/**
 * গ্রাহক সম্পর্কে আমাদের নিজেদের কথা গ্রাহক পড়বেন না।
 *
 ...
 *
 * ⚠️ গ্রাহক ওটা পড়লে **সম্পর্কই শেষ**। আর ক্ষতিটা ফেরানো যায় না —
 ...
 * **নাম কাউকে থামায় না**: একদিন কেউ পোর্টালের পাতায় গ্রাহকের তথ্য
 ...
 * সত্যিই দরকার হলে (ধরা যাক গ্রাহক নিজের "ভালো" পতাকাগুলো দেখবেন)
 * নামটা তালিকায় বসিয়ে **কারণ লিখতে হবে** — তখন সিদ্ধান্তটা কারো
 * চোখের সামনে ঘটে, নীরবে নয়।
 */
class WhatWeSayAboutACustomerStaysOnOurSideTest extends TestCase
{
    /**
     * পোর্টালের যেসব ফাইল গ্রাহক নিজে দেখেন।
     *
     ...
     *
     * আজ খালি, আর সেটাই ঠিক: গ্রাহকের নিজের পাতায় আমাদের পর্যবেক্ষণের
     * কোনো কাজ নেই।
     *
    ...
    public function test_no_portal_screen_reads_what_we_wrote_about_the_customer(): void
    {
        ...
        $this->assertSame([], $offenders, implode("\n", [
            'পোর্টালের পর্দা গ্রাহক সম্পর্কে আমাদের নিজেদের কথা ছুঁয়েছে।',
            '',
            ...$offenders,
            '',
            'ওই নোটগুলো কাউন্টারের জন্য — "৯০ দিন নেয়", "গাড়ি দাঁড় করিয়ে',
            'রাখে"। গ্রাহক পড়লে সম্পর্কই শেষ, আর ওটা ফেরানো যায় না।',
            '',
