...
# প্রতিটা সারি: (নাম, নির্বাচক, কেন এটা ওই ERP-কে চেনায়)
PARTS = {
    ...
    "apps": [
        ...
        ("upper-heads", ".ui-list th[data-upper]",
         "কলামের শিরোনাম ছোট, বড়-হাতের, ফাঁক দেওয়া"),
        ("topbar-avatar", "[data-odoo-avatar]",
         "গোল সাদা অ্যাভাটার, বেগুনি অক্ষরে"),
        ("footer-plain", "[data-footer-plain]",
         "ওডুর ফুটার নেই — আমাদেরটা সরু ও নিঃশব্দ হবে"),
    ],
