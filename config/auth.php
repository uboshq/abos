...
return [
    ...
    */
    ...
    'guards' => [
         ...
         * এক গার্ডে দুই ধরনের মানুষ রাখলে একজন কর্মী আর একজন গ্রাহক
    ...
    */
    ...
    'providers' => [
        /*
         * ড্রাইভার `customers`, `eloquent` নয় — আর কারণটা জরুরি।
         *
         * সাধারণ eloquent প্রোভাইডার সেশন থেকে গ্রাহক তোলার সময়
         * `Customer::query()` চালায় গ্লোবাল স্কোপসহ, অথচ ওই কোয়েরিটা
         * কোম্পানি বসার আগে চলে। ফলে পোর্টালের প্রতিটা অনুরোধে ৫০০
         * আসত। পুরো ব্যাখ্যা `App\Modules\Sales\Auth\CustomerProvider`-এ।
         */
        'customers' => [
            'driver' => 'customers',
