...
class BooksCheck extends Command
{
    ...
    private function checkOne(IntegrityRegistry $registry, Company $company): int
    {
        ...
        if (! $chain['ok']) {
            ...
            /*
             * তিনটা আলাদা ঘটনা, তিনটা আলাদা বাক্য।
             *
             ...
             */
            /*
             * ⭐ তৃতীয় বাক্যটা — সিল ছাড়া সারি, ২১ সেপ্টেম্বর ২০২৬।
             *
             * ⚠️ এটা বাকি দুইটার চেয়ে **খারাপ খবর**: ঐ দুইটায় যা ছিল
             * তা বদলেছে, এখানে **যা ছিল না তা যোগ হয়েছে**। ⓘ তাই
             * বার্তাটা ব্যাকআপ মেলানোর কথা বলে না — বলে ঐ সারিটা
             * কোথা থেকে এল সেটা খুঁজতে।
             */
            $message = $chain['reason'] === LedgerChain::UNSEALED
                ? sprintf(
                    'খতিয়ানে সিল ছাড়া একটা সারি আছে — %s · সারি #%d। ইঞ্জিন দিয়ে বসানো '
                    .'প্রতিটা সারির সিল থাকে, তাই এটা অ্যাপের বাইরে দিয়ে ঢোকানো হয়েছে। '
                    .'ঐ সারিটা কে আর কীভাবে বসাল তা খুঁজুন — ব্যাকআপ ফেরানো এর উত্তর নয়।',
                    $company->code,
                    (int) $chain['broken_at'],
                )
                : ($chain['reason'] === LedgerChain::TAIL
                ? sprintf(
