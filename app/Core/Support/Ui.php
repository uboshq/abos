...
final class Ui
{
    ...
    */
    ...
    public static function changesArrangement(?string $key): bool
    {
        ...
        return $shape($look) !== self::PLAIN_ARRANGEMENT;
    }

    /**
     * সাদামাটা বিন্যাস — যার সাথে মিললে রূপটা "কেবল রং"।
     *
     * ── কেন এটা আর `DEFAULT` নয় ─────────────────────────────────────
     * এতদিন তুলনাটা হত ডিফল্ট রূপের (`navy`) সাথে, আর সেটা তখন কাজ
     * করত কারণ navy নিজেই ছিল সাদামাটা।
     *
     * ৪ সেপ্টেম্বর ২০২৬-এ navy নিজের `chips` ছাঁকনি আর নিজের খোলস
     * পেয়েছে — অর্থাৎ সে আর মানদণ্ড নয়, সে এখন একটা **সাজ**। ⛔ তাতে
     * প্রতিটা অন্য রূপ "ডিফল্টের চেয়ে আলাদা" হয়ে গিয়েছিল, আর চেহারার
     * পাতায় *"কেবল রং"* শিরোনামটা খালি পড়ে ছিল।
     *
     * ⚠️ ধরা পড়েছে ওই খালি দলটার পাহারায় —
     * [[AClonePromisedAShapeAndDrewAnotherTest]] — কোড পড়ে নয়।
     *
     * ⭐ তাই মানদণ্ডটা এখন কোনো রূপ নয়, লেখা চারটা মান: রেল · ইনলাইন
     * কমান্ড · চাপলে-খোলা ছাঁকনি · শিরোনামে দৃশ্য। ⓘ কোনো রূপ
     * সাদামাটা থাকা বন্ধ করলেও এই তুলনাটা আর নড়বে না।
     */
    private const PLAIN_ARRANGEMENT = ['rail', 'inline', 'toggle', 'title'];
