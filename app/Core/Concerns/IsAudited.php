...
trait IsAudited
{
    ...
    /**
     * এই মডেলের যে ঘরগুলো অডিটে যাবে না।
     *
     * ── কেন এটা দরকার হলো ───────────────────────────────────────────
     * নম্বর-সিরিজের next_number প্রতিটা ডকুমেন্ট তৈরিতে এক বাড়ে, আর
     * তাতে অডিটে "সম্পাদনা — next_number: ৬ → ৭" একটা সারি জমত। বছরে
     * হাজার বিল মানে হাজারটা এমন সারি, আর তার ফাঁকে আসল পরিবর্তনগুলো
     * খুঁজে বের করা কঠিন হয়ে যেত। তথ্যটাও নতুন কিছু বলত না: নম্বরটা
     * কোন ডকুমেন্টে গেল, সেই ডকুমেন্টটা নিজেই অডিটে আছে।
     *
     * মডেল নিজে বলে দেয়, কারণ কোন ঘরটা যন্ত্রের হিসাব সেটা সে-ই জানে।
     *
     * @return list<string>
     */
