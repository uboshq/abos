...
return [
     ...
     */
    /*
     * ⭐ গোটা মডিউলটা ডিফল্টে বন্ধ — মালিকের নির্দেশ, ২২ সেপ্টেম্বর ২০২৬।
     *
     * ── ⓘ কেন ───────────────────────────────────────────────────────
     * ABOS-এর ব্যবহারকারী একটা **ডিপো** — মাল কেনে আর বেচে, বানায় না।
     * ⚠️ রেস্তোরাঁর রান্নাঘর, টিকিট, রেসিপি — কোনোটাই তার কাজে লাগে না,
     * অথচ মেনুতে বসে থাকত আর প্রতিদিন চোখে পড়ত।
     *
     * ⓘ মালিক নিজে দেখে বললেন: *"রেস্টুরেন্ট ডিফল্ট বন্ধ করে রাখো,
     * POS-এর মতো"*। ⭐ আর [[sales.screen_pos]]-এ ঠিক এই কাজটাই আগে থেকেই
     * করা, একই কারণে: *"কাউন্টার POS দোকানের জিনিস, পরিবেশকের নয়"*।
     *
     * ── ⚠️ বন্ধ, মুছে ফেলা নয় ───────────────────────────────────────
     * কোড, রুট, কাগজ — সব যেমন ছিল তেমনই। ⓘ যেদিন কেউ সত্যিই রান্নাঘর
     * চালাবে, সেদিন সুইচটা খুলে দিলেই সব ফিরে আসে, আর পুরনো কাগজগুলোও
     * তাদের নিজের ঠিকানায় খোলা থাকে।
     *
     * ⚠️ চাবিটা `restaurant.enabled` — নামটা বানানো নয়,
     * [[MenuBuilder::moduleEnabled()]] ঐ ছাঁচেই (`<module>.enabled`)
     * প্রতিটা মডিউল দেখে। ⓘ এতদিন কেউ ঘোষণা না করায় ওটা হার্ডকোড করা
     * `true`-তে পড়ত; এখন ঘোষিত ডিফল্টটাই উত্তর দেয়।
     */
    'settings' => [
        [
            'key' => 'restaurant.enabled',
            'label' => 'restaurant::settings.enabled',
            'type' => 'boolean',
            'default' => false,
            'group' => 'screens',
        ],
     ...
     *
     * ⓘ মেনু ও ছাড়ের অনুমোদন — বিক্রয়ের আদায়টা Sales-এর ঘরে।
     *
