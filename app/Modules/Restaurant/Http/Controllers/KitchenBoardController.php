...
use App\Modules\Restaurant\Services\RecipeService;
...
class KitchenBoardController extends Controller implements HasMiddleware
{
    ...
    public static function middleware(): array
    {
        return [
            /*
             * চাবিটা রেস্তোরাঁর নিজের, মজুদের নয়।
             *
             * ── কী ভাঙা ছিল ─────────────────────────────────────────
             * এই কন্ট্রোলারটা মজুদ থেকে রেস্তোরাঁয় আনা হয়েছে, আর `can:`
             * অপরিবর্তিত রয়ে গিয়েছিল। মেনু ও ড্যাশবোর্ডের টালি চাইত
             * `restaurant.kitchen.view`, রুট চাইত `inventory.recipe.view` —
             * তাই যাঁর মেনুর চাবি আছে অথচ রুটেরটা নেই, তিনি **সারিটা
             * দেখতেন আর ক্লিক করলে ৪০৩ পেতেন**, রোজ।
             *
             * ── কেন মেনু নয়, রুট বদলানো হলো ─────────────────────────
             * প্রথমে মেনুর চাবিটা রুটের সাথে মেলানোর চেষ্টা হয়েছিল
             * (কম ক্ষতির পথ ভেবে)। ⚠️ কিন্তু বুট-টাইম যাচাইকারী সেটা
             * প্রত্যাখ্যান করে: **একটা মডিউলের মেনু কেবল সেই মডিউলের
             * ঘোষিত অনুমতির নাম দিতে পারে**, নাহলে সারিটা কেউ কোনোদিন
             * দেখত না। অর্থাৎ ওই পথটা খোলাই ছিল না।
             *
             * ── আর কারও প্রবেশাধিকার যায়নি, মেপে দেখা ───────────────
             * `inventory.recipe.view` ও `restaurant.kitchen.view` — দুইটাই
             * আজ **একই রোলের** (`owner`)। তাই বদলটায় কেউ কিছু হারাচ্ছেন
             * না, আর রেস্তোরাঁ-মাত্র কোম্পানিকে আর মজুদের চাবি দিতে
             * হচ্ছে না।
             */
            new Middleware('can:restaurant.kitchen.view'),
        ];
    }
