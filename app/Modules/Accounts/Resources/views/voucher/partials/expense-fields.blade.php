...
<section data-boxed
    ...
    <div class="mt-4 grid gap-4 lg:grid-cols-2">
        ...
        --}}
        {{--
            ⭐ "কীভাবে দেওয়া হলো" ডান কলামের **উপরে** — মালিক, ২১ সেপ্টেম্বর ২০২৬।

            ⛔ আগে এটা সংযুক্তির **পরে** লেখা ছিল, আর গ্রিড নিজের নিয়মে
            সাজায়: সংযুক্তিতে `lg:col-start-1` থাকায় সে দ্বিতীয় সারিতে
            নামত, আর এই ব্লকটাও তার পাশে — ফলে **ডান কলামের উপরের অংশটা
            খালি পড়ে থাকত**। ⓘ মালিক ছবিতে ঠিক ঐ খালি জায়গাটাই মার্ক করে
            বলেছেন: *"box ta upore markore dewa jaygay bosaw"*।

            ⚠️ কেবল ক্রম বদলেই মেটে, কোনো নতুন শ্রেণি লাগে না: এটা আগে
            লেখায় (২,১)-এ বসে, আর সংযুক্তি নিজের `col-start-1` ধরে
            (১,২)-তে নামে — অর্থাৎ উৎসে কর্তনের ঠিক নিচে।
        --}}
        ...
        {{-- ⓘ সংযুক্তি উৎসে কর্তনের ঠিক নিচে — বাম কলামের খালি জায়গাটা --}}
