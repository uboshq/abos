...
<section data-boxed
    ...
    <div class="mt-4 grid gap-4 lg:grid-cols-2 lg:items-start">
        ...
        {{--
            সংযুক্তি — বাম কলামের সবার নিচে, ছবির ছোট মার্ক করা ঘরটায়।

            ⓘ ঘরটা ছোটই থাকে: ভিতরে কেবল একটা ফাইল-বাছাই আর এক লাইন
            ব্যাখ্যা, তাই `space-y-4` ছাড়া আর কিছু লাগে না।
        --}}
        @include('accounts::voucher.partials.attachment-field')
        </div>

        {{--
            ডান কলাম — কীভাবে দেওয়া হলো (নগদ · মোবাইল ব্যাংকিং · চেক…),
            আর তার নিচেই নোটের হিসাব।

            ⭐ মালিকের ছবি, ২১ সেপ্টেম্বর ২০২৬: *"কীভাবে দেওয়া হলো
            daner markora boxer jaygay"* — অর্থাৎ ডান কলামের একদম উপরে।

            ⓘ এটাই পর্দার সবচেয়ে লম্বা বাক্স, তাই নিজের একটা কলাম
            পেলে বামের তিনটার উচ্চতা আর এর সাথে বাঁধা থাকে না।
        --}}
