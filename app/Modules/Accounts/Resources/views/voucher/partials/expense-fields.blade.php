...
<section data-boxed
    ...
    {{--
        ── দুই কলাম: বাঁয়ে তিনটা প্রশ্ন, ডানে টাকাটা কীভাবে গেল ──────────

        ⭐ মালিকের ছবি, ২১ সেপ্টেম্বর ২০২৬ — তিনটা জায়গা মার্ক করা:
        *"কোন চালানের জন্য box bame mark er vitor, কীভাবে দেওয়া হলো
        daner markora boxer jaygay, সংযুক্তি niche cuto mark kora box e"*।
        ...
        ⛔ আগে "কোন চালানের জন্য" গ্রিডের **বাইরে**, পুরো চওড়ায় ছিল —
        ছয় কলামের টেবিলটা পর্দা জুড়ে টানা যেত, আর ডান কলামের উপরের
        অংশটা তখন কিছুই ধরত না। ⓘ মালিক ছবিতে ঐ খালি ডান ঘরটাতেই
        "কীভাবে দেওয়া হলো" বসাতে বলেছেন।

        ⚠️ `min-w-0` বাদ দেওয়া যাবে না: গ্রিডের ঘরের স্বাভাবিক
        `min-width: auto` মানে ভিতরের চওড়া টেবিলটা ঘরটাকে ঠেলে বড়
        করে দেবে — তখন `overflow-x-auto` কিছুই করে না, আর দুই কলামের
        মাপ আবার এলোমেলো হয়ে যাবে।

        ⓘ `lg:items-start` — বাম কলামের তিনটা বাক্স ডান কলামের নোটের
        হিসাবের সমান উঁচু হয়ে টেনে যাওয়ার দরকার নেই।
    --}}
    <div class="mt-4 grid gap-4 lg:grid-cols-2 lg:items-start">
        {{-- বাম কলাম — চালান · উৎসে কর্তন · সংযুক্তি, একটার নিচে একটা --}}
        ...
        {{--
            ...
            ⚠️ "কার মাধ্যমে · কখন" ঘর দুইটা নেই — মালিকের নির্দেশ:
            *"দুইটাই বাদ দাও"*।
        --}}
        ...
        {{--
            ডান কলাম — কীভাবে দেওয়া হলো, তার নিচে সংযুক্তি।

            ⭐ মালিকের ছবি, ২১ সেপ্টেম্বর ২০২৬ — দুই দফায়। প্রথমে
            *"কীভাবে দেওয়া হলো daner markora boxer jaygay"*, তারপর
            ছবিতে চেকের ঘরগুলোর নিচের খালি জায়গাটা লাল করে মার্ক করে:
            *"সংযুক্তি dane lal mark kora jaygay niye daw"*।

            ⓘ সংযুক্তি আগে বাম কলামে ছিল। তাতে বাঁয়ে তিনটা বাক্স জমে
            লম্বা হয়ে যেত, আর ডানে চেকের ঘরগুলোর নিচে বড় একটা ফাঁকা
            পড়ে থাকত — মালিক ছবিতে ঠিক ঐ ফাঁকাটাই দেখিয়েছেন।

            ⚠️ `space-y-4` দুইটার মাঝে ফাঁক দেয়। দুইটাকে আলাদা গ্রিড-ঘর
            করা যেত না: তাহলে সংযুক্তি তৃতীয় কলাম খুঁজত, আর গ্রিডে কলাম
            দুইটাই — ফলে সে বামে নেমে যেত, ওই ফাঁকাটা অক্ষত রেখেই।
        --}}
        <div class="min-w-0 space-y-4">
        ...
        {{--
            সংযুক্তি — ছবির লাল ঘরটায়, চেকের ঘরগুলোর ঠিক নিচে।

            ⓘ বাক্সটা ছোটই থাকে: ভিতরে কেবল একটা ফাইল-বাছাই
            আর এক লাইন ব্যাখ্যা।
        --}}
