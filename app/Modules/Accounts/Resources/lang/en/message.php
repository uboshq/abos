...
return [
    ...
    'inter_company_only_given' => 'What this company has given. To see what it received, switch to that company — the entry sits in its books.',
    'inter_company_none' => 'No inter-company money has moved yet.',
    'inter_company_no_sister' => 'You belong to one company only, so there is no sister company to pay.',
    'inter_company_moves_money_only' => 'Move money, pay an expense or settle a debt — all three from this one screen.',
    'inter_company_purpose_hint' => 'Six months from now the row should still explain itself.',
    'inter_company_what_posts' => 'Saving writes one entry in each book: in ours the inter-company current account is debited and the money account credited; in theirs the account you chose is debited and their current account credited.',
    'inter_company_done' => 'Money sent to :company, and both books now say so.',
    'inter_company_three_kinds' => 'Which of their accounts you choose decides what this is — a money account moves money, an expense account pays their expense, a liability account settles their debt.',
    'inter_company_to_hint' => 'A money, expense or liability account — what you pick is what lands in their books.',
