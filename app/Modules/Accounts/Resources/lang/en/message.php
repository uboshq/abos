...
return [
    ...
    'group_between' => ':from to :to — all companies together',
    'group_total' => 'Group total',
    'group_only_one' => 'You belong to one company only, so there is a single row below.',
    'group_no_companies' => 'You are not attached to any company yet, so there is nothing to show.',
    'group_not_consolidated' => 'Transactions between the companies are not removed here — money one company pays another is counted twice in the total.',
