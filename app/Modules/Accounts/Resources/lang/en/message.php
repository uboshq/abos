...
return [
    ...
    'inter_company_moves_money_only' => 'Moving money — not paying another company\'s expense directly.',
    'inter_company_purpose_hint' => 'Six months from now the row should still explain itself.',
    'inter_company_what_posts' => 'Saving writes one entry in each book: in ours the inter-company current account is debited and the money account credited; in theirs the exact opposite.',
