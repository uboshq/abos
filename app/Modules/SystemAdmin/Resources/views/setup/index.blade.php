        ...
        <main>
            <div class="rounded-2xl border border-(--color-border) bg-(--color-surface-card)
                ...
                <form method="POST" action="{{ route('system_admin.setup.store') }}"
                    ...
                    {{-- ⛔ পাতার ভাষাটা অ্যাকাউন্টেও যায়।

                         ── কী ভাঙা ছিল, ১৩ সেপ্টেম্বর ২০২৬ ──────────────
                         উপরের কোণের বোতামটা পাতার ভাষা বদলাত, কিন্তু
                         সেই বাছাটা ফর্মের সাথে **যেত না** — কোনো `locale`
                         ঘর পাঠানোই হত না। কন্ট্রোলার ঘরটা যাচাই করত
                         (`nullable|in:bn,en`), আর [[FirstRun]] না পেলে
                         `bn` ধরে নিত।

                         ⚠️ ফল: যিনি পুরো সেটআপটা ইংরেজিতে পড়ে শেষ করলেন,
                         তাঁর অ্যাকাউন্ট বসত বাংলায় — আর ঢোকার পর তিনি
                         এমন একটা পর্দা পেতেন যেটা তিনি পড়তে পারেন না।
                         ⓘ ঠিক যে জিনিসটা ঠেকাতে বোতামটা বসানো, সেটাই
                         এক ধাপ পরে ফিরে আসত।

                         ⓘ যাচাইটা কন্ট্রোলারে আগেই ছিল — কেবল ঘরটা
                         কোনোদিন পাঠানো হয়নি। একটা নিয়ম যা এমন ঘর পাহারা
                         দেয় যা কেউ পাঠাতেই পারে না। --}}
