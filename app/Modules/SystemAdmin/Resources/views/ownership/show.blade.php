...
<x-layouts.app :menu="$menu">
    ...
    <div class="max-w-xl space-y-4">
        ...
        {{-- ⛔ কেন কাজটা হলো না, সেটা বলার ঘর — ১৫ সেপ্টেম্বর ২০২৬।
             ...
             নিচে মালিকানা হস্তান্তরের একটা POST ফর্ম আছে, আর সেটা
             ভ্যালিডেশনে আটকালে ব্যবহারকারী **কিছুই দেখতেন না** —
             বোতাম চাপা যেত, পাতা ফিরে আসত, আর কোনো কারণ থাকত না।

             ⚠️ এই পর্দাটায় সেটা সবচেয়ে খারাপ: মালিকানা বদল এমন কাজ
             যেটা কেউ দুইবার চেষ্টা করতে ভয় পান, আর নীরব ব্যর্থতা দেখে
             ধরে নেন ব্যবস্থাটাই ভাঙা। --}}
        <x-ui.errors />
