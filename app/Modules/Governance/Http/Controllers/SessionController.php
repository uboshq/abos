...
class SessionController extends Controller
{
    ...
    /**
     * ⛔ পাতা ভাগ নেই, ইচ্ছাকৃত — কেবল নিজের সেশন, আর সেগুলো জমে না।
     *
     * ছাঁকনিটা `where('user_id', নিজে)`, তাই একটা সারি মানে একজনের
     * একটা ব্রাউজার বা ফোন — সংখ্যাটা হাতে গোনা। আর সারিগুলো থেকেও
     * যায় না: মেয়াদ শেষ হলে ফ্রেমওয়ার্কের নিজের ঝাড়ু ওগুলো মুছে দেয়।
     *
     * ⚠️ আর এই পর্দার কাজটাই সবগুলো একসাথে দেখা — "আমার নামে আর কোথায়
     * কে ঢুকে আছে"। একটা সেশন দ্বিতীয় পাতায় লুকিয়ে গেলে ঠিক সেটাই
     * চোখ এড়াত, যেটা খুঁজতে মানুষ এই পর্দায় আসেন।
     *
