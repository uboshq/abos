...
class ExportLogController extends Controller implements HasMiddleware
{
    ...
    public static function middleware(): array
    {
         ...
         *
         * ── ⛔ আগে এখানে অডিটের চাবি ছিল, আর যুক্তিটা ছিল ─────────────
         ...
         *
         * ⚠️ যুক্তিটা ভুল ছিল না, কিন্তু **উল্টো দিকটা দেখেনি**: এক চাবি
         * মানে কাউকে রপ্তানির খাতা দেখাতে হলে তাকে **পুরো অডিট ট্রেইলও**
         * দিতে হত — অর্থাৎ প্রতিটা বেতন, প্রতিটা দর, প্রতিটা ছাড়।
         *
         * ⛔ নিরীক্ষার কথা: *"অডিট ট্রেইল, রপ্তানি লগ, লগইন ইতিহাস ও ত্রুটি
         * লগ একই চাবিতে খোলে। চারটি আলাদা চাবিতে ভাগ করুন।"*
         *
         * ⓘ যিনি অডিট দেখেন তিনি এখনো রপ্তানিও দেখেন — ভূমিকা-ছাঁচে
         * দুইটাই একসাথে দেওয়া আছে। ⭐ কিন্তু এখন **আলাদা করে কম দেওয়াও
         * যায়**, আর অনুমতির পুরো মানেই সেটা।
         */
        return [new Middleware('can:governance.export.view')];
    }
