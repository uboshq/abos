...
return [
     ...
     */
    /*
     * ── ভেতরে গিয়ে আবার বাইরে, ৪ সেপ্টেম্বর ২০২৬ ──────────────────────
     * সকালে মালিক বলেছিলেন গ্রাহককে বিক্রয়ের ভেতরে ঢোকাতে, আর সেটা
     * করা হয়েছিল (`nav.under`, কমিট 121c644)। **বিকেলে তিনি নিজেই
     * ফিরিয়ে নিয়েছেন** — *"আগের মতো বাইরেই রাখো, সেটাই মনে হয় ভালো।"*
     *
     * তাই রেলে গ্রাহকের নিজের টাইল আবার আছে, ২ সেপ্টেম্বরের ক্রম মতোই।
     *
     * ⓘ ভেতরে বসানোর যন্ত্রটা কোডে রয়ে গেছে
     * ([[MenuBuilder::settleGuestsIntoTheirHosts()]]) — **আজ কেউ ব্যবহার
     * করে না**, কিন্তু তার সাথে আসা `codes`-এর কাজটা আটটা শেলের একটা
     * সত্যিকারের বাগ সারিয়েছে, তাই ওটা টিকে থাকে।
     */
    /*
     * ⭐ মজুদের **পরে**, বিক্রয়ের আগে — মালিকের সিদ্ধান্ত, ৫ সেপ্টেম্বর
     * ২০২৬: *"সরবরাহকারী · ক্রয় · মজুদ · গ্রাহক · বিক্রয় · রেস্টুরেন্ট
     * এইভাবে বসাবে।"*
     *
     * ── কেন এই ক্রম ─────────────────────────────────────────────────
     * ⓘ এটা **মালের পথ**: সরবরাহকারী মাল দেন → আমরা কিনি → গুদামে ঢোকে
     * → গ্রাহক আসেন → বিক্রি হয়। মেনুটা এখন যে ক্রমে কাজ হয় সেই ক্রমেই
     * দাঁড়ায়, আর নতুন কর্মীকে ক্রমটাই ব্যবসাটা শিখিয়ে দেয়।
     *
     * ⚠️ আগে গ্রাহক সবার আগে ছিল (order ১০) — বর্ণানুক্রমে নয়, বরং
     * "গ্রাহকই আগে" ভেবে। ⓘ কিন্তু কাগজের দিক থেকে গ্রাহক আসেন
     * **মাল আসার পরে**, আর ডিপোর দিনটাও তাই শুরু হয় গাড়ি দিয়ে।
     *
     * ⓘ ৪৫ — মজুদের (৪০) পরে, বিক্রয়ের (৫০) আগে। বাকি পাঁচটার একটাও
     * ছুঁতে হয়নি।
     */
    'nav' => ['section' => 'business', 'order' => 45],
    ...
    /*
     * ⭐ বাকির সীমা বাড়ানো — মালিকের সিদ্ধান্ত, ১৮ সেপ্টেম্বর ২০২৬।
     *
     * ⓘ সীমাটাই সবচেয়ে চুপচাপ দরজা: একবার বাড়িয়ে দিলেই ওই
     * গ্রাহকের কাছে যত খুশি মাল বাকিতে যায়, আর প্রতিটা বিক্রয়
     * নিয়ম মেনেই হয় — কোথাও কিছু ভাঙে না।
     *
     * ⚠️ ধরা পড়ে বহু পরে, যখন টাকাটা আর ওঠে না।
     *
     * ⓘ কেবল বাড়ালে সই চায়, কমালে নয় — সীমা কমানো ঝুঁকি কমায়।
     */
    'approvals' => [
        'credit_limit' => 'customer::approval.credit_limit',
    ],

    /*
     * ⛔ যে কাজগুলোতে **টাকা নড়ে** — ২৪ সেপ্টেম্বর ২০২৬।
     *
     * ⭐ মালিকের সিদ্ধান্ত: এগুলোতে **একসাথে সই দেওয়া যায় না**
     * ([[BulkApproval]]) — একটা একটা করে দেখে দিতে হবে।
     *
     * ⓘ বাকির সীমা ও ছাড়ের ছক — কাগজের নিয়ম, খাতায় কিছু বসে না।
     *
     * ⚠️ তালিকাটা খালি, আর সেটা একটা **ঘোষণা**, অনুপস্থিতি নয়:
     * চাবিটা না থাকলে আর খালি থাকলে কোডে এক, কিন্তু মানুষের কাছে
     * এক নয় — প্রথমটা মানে কেউ ভেবে দেখেনি। ⓘ পাহারাটা
     * [[EveryModuleSaysWhereMoneyMovesTest]]-এ।
     */
    'moves_money' => [],
