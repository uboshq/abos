...
/**
 * ডিলারকে নিজের পাতার চাবি দেওয়া — আর ফেরত নেওয়া।
 *
...
final class CustomerPortalService
{
     ...
     * "ডিলারকে একটা পাসওয়ার্ড দিলাম"। আলাদা করলে "চালু আছে কিন্তু
     * পাসওয়ার্ড নেই" নামে একটা অবস্থা তৈরি হত — যেখানে ডিলার লগইন
    ...
    public function enable(Customer $customer, string $password): Customer
    {
        ...
        DB::transaction(function () use ($customer, $password, $wasEnabled): void {
             ...
             *
             * কিন্তু বাদ দিলে ঘটনাটাও হারাত। "ডিলারের পাসওয়ার্ড কে
     ...
     * ভুল করে বন্ধ করা ডিলারকে আবার চালু করতে নতুন পাসওয়ার্ড লাগে না,
