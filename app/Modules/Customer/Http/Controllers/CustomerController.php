...
class CustomerController extends Controller implements HasMiddleware
{
    ...
    public function index(Request $request): View
    {
        $query = Customer::query()
             ...
             *
             * ── কেন এতগুলো `parent` ──────────────────────────────────
             * তালিকায় দুইটা কলাম: গ্রাহকের নিজের অবস্থান, আর তার
             * **এলাকা**। এলাকাটা সরাসরি বসানো থাকে না — গ্রাহক বসেন
             * রুট, পয়েন্ট বা টেরিটরিতে, আর সেখান থেকে
             * [[Customer::area()]] গাছ বেয়ে উপরে উঠে এলাকা খোঁজে
             * ([[Location::ancestors()]])।
             *
             * আগে থেকে না আনলে প্রতিটা সারি নিজে নিজে উপরে উঠত — ৫০
             * সারির পাতায় কয়েকশো কোয়েরি, আর কোনো লক্ষণ নেই, শুধু
             * পাতাটা ধীরে খোলে। preventLazyLoading চালু করার পর এটা
             * ৩১ আগস্ট ২০২৬-এ পর্দা খুলতেই ধরা পড়েছে।
             *
             * ধাপগুলো আগে থেকে আনলে Eloquent **প্রতি ধাপে একটা** কোয়েরি
             * করে, সারি যত বেশিই হোক। ছয় ধাপ নেওয়া হয়েছে কারণ মইটা
             * সাতটা: দেশ › বিভাগ › অঞ্চল › এলাকা › টেরিটরি › পয়েন্ট ›
             * রুট — সবচেয়ে নিচ থেকে সবচেয়ে উপরে ছয় লাফ।
             */
            ->with([
                'partyType',
