...
final class StockOnHandSync implements SyncsToDevices
{
    ...
    public function pull(User $user, ?Carbon $since, int $limit): array
    {
         ...
         *
         * ── সংজ্ঞাটা বদলেছে, ৪ সেপ্টেম্বর ২০২৬ — আর এটা ইচ্ছাকৃতভাবে
         *    এখানে আসেনি ─────────────────────────────────────────────
         * Stock Placement দুইটা নতুন ঘর এনেছে (`unplaced`,
         * `unplaced_free`), আর `statesForAll()` এখন সেগুলোও ফেরত দেয়।
         * **এই কোয়েরিটা ওগুলো পাঠায় না, আর সেটা ঠিক আছে:**
         *
         * ⭐ ফোন `available = floor − reserved − hold` নিজে গোনে, আর
         * বসানো হয়নি এমন মাল `floor`-এ নেই — তাই **ফোনের সংখ্যা আপনা
         * থেকেই সঠিক**, আর মাঠের লোক এমন মাল বেচতে পারবেন না যা এখনো
         * কেউ বুঝে নেয়নি। ⓘ sync কোনো "মোট" পাঠায় না, পাঁচটা অবস্থা
         * পাঠায় — তাই কোথাও মাল উধাও দেখানোরও সুযোগ নেই।
         *
         * ⛔ ষষ্ঠ-সপ্তম কলাম পাঠানো মানে **ফোনের অ্যাপেও বদল**, আর ওটা
         * HP-র টিমের কাজ — তাদের সময়সূচি আমাদের হাতে নেই। *"মাঠের লোক
         * কি জানতে পারবেন গুদামে মাল বসার অপেক্ষায় আছে?"* — প্রশ্নটা
         * বৈধ, কিন্তু ওটা আলাদা কাজ, আর মালিকের সিদ্ধান্ত।
         */
