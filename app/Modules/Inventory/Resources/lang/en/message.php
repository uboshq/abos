...
return [
    ...
    'qc_note' => 'Opening a paper changes nothing in stock. The goods only move when someone records the decision.',
    'qc_no_products' => 'No product is marked as needing inspection. Tick it on the product first.',
    'qc_opened' => 'The inspection is open. Stock has not moved.',
    'qc_decided' => 'The decision is recorded and the stock reflects it.',
    'qc_decide_note' => 'Quarantine holds all of it; rejected holds only the rejected part. Held goods stay in the warehouse but cannot be sold.',
    'qc_waiting_for_inspector' => 'This paper is waiting for someone who can record the decision.',
    'qc_required_hint' => 'Goods of this product wait for an inspection before they can be sold.',
    'planning_hint' => 'Leave a box empty if it has not been decided. Empty is not zero - an empty maximum does not mean the maximum is zero.',
    'no_serials' => 'No serial numbers yet.',
    'serial_not_found' => 'No piece carries that number.',
    'serial_search' => 'Type or scan a number',
    'serial_note' => 'Numbers only say where a piece is. Quantities stay with the stock ledger.',
