...
@php
    ...
    /*
     * ক্রয়মূল্য — আর তার সাথে মার্জিন ও মার্কআপ — কেবল অনুমতিওয়ালার।
     *
     * ── কেন তিনটাই, একটা নয় ─────────────────────────────────────────
     * ঘোষণাটা কেবল `purchase_price`-এর উপর (মডিউলের `sensitive_fields`),
     * কিন্তু **মার্জিন ও মার্কআপ ওই সংখ্যারই অন্য চেহারা**: বিক্রয় দর
     * পর্দাতেই আছে, তাই মার্জিন থেকে ক্রয়মূল্য এক ধাপে বেরিয়ে আসে।
     * একটা লুকিয়ে বাকি দুইটা রাখলে লুকানোটা অলংকার হত।
     *
     * ── কেন কলামটাই সরানো, খালি ঘর নয় ───────────────────────────────
     * ⚠️ **কলামের অস্তিত্বই খবর।** "ক্রয়মূল্য" শিরোনামের নিচে খালি ঘর
     * দেখলে ব্যবহারকারী জানেন সংখ্যাটা আছে, কেবল তাঁকে দেখানো হচ্ছে না —
     * আর তখন সেটা জিজ্ঞেস করে বা অন্য পথে বের করে নেওয়ার চেষ্টা শুরু হয়।
     *
     * ── আর এটা টুলবারও ঠিক করে দেয় ──────────────────────────────────
     * Columns মেনু এই একই `$columns` পড়ে, তাই অনুমতিহীন ব্যবহারকারী
     * তালিকাটাতেও নাম তিনটা দেখেন না। **নাহলে মেনুটা নিজেই বলে দিত
     * কী কী লুকানো আছে** — যেটা লুকানোর উদ্দেশ্যটাই নষ্ট করত।
     *
     * ⓘ পণ্যের পাতা বিক্রয়কর্মীও খোলেন, খুলতেই হয় — নাহলে বিক্রি করবেন
     * কী করে। **পাতাটা বন্ধ করা উত্তর নয়, ঘরটা বন্ধ করা উত্তর।**
     */
    if (! \App\Core\Security\FieldSecurity::visible(
