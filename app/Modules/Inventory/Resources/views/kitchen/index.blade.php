...
<x-layouts.app :menu="$menu">
    <x-slot:title>{{ __('inventory::menu.kitchen_board') }}</x-slot:title>

    <x-slot:header>
        <x-ui.page-header :title="__('inventory::menu.kitchen_board')"
                          :subtitle="__('inventory::message.kitchen_note')" />
    </x-slot:header>
    ...
    <div x-data="{
             ...
             async pull() {
                 ...
                 this.busy = true;
                 try {
                     const r = await fetch('{{ route('inventory.kitchen.refresh', request()->query()) }}',
        ...
        <x-ui.table
            ...
            :columns="[
                ...
                ['key' => 'portions', 'label' => __('inventory::field.portions_possible'),
                 ...
                 'render' => fn ($d) => view('inventory::kitchen.partials.portions', ['dish' => $d])],
