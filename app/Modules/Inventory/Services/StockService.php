...
final class StockService
{
    ...
    public function issue(
        ...
        /*
         * ⭐ বলা লট — সবার শেষে, ডিফল্ট `null`, আর সেটাই আসল কথা।
         *
         * ── ⓘ কেন ঐচ্ছিক ─────────────────────────────────────────────
         * `null` মানে **আজকের আচরণ, হুবহু**: লট ধরা পণ্যে FEFO চলে
         * ([[BatchAllocator]])। ⚠️ ক্রয়, স্থানান্তর, সমন্বয়, ফেরত —
         * কেউ এই তর্কটা দেয় না, তাই কারো আচরণ এক চুলও বদলায় না।
         *
         * ── ⛔ কেন এটা লাগল ──────────────────────────────────────────
         * মালিকের সিদ্ধান্ত, ২৫ সেপ্টেম্বর ২০২৬: কাউন্টারে লট বাছা
         * **বাধ্যতামূলক**। ⚠️ বাছাইটা এখান পর্যন্ত না পৌঁছালে সে নীরবে
         * হারাত — কাগজে এক লট, গুদাম থেকে যেত অন্যটা, আর পার্থক্যটা
         * ধরা পড়ত কেবল রিকলের দিন।
         *
         * ⓘ লট ধরা **নয়** এমন পণ্যে এটা উপেক্ষিত: ওখানে লট বলে কিছু
        ...
        /*
         * ⭐ লট বলা থাকলে বাছাই হয় না — বলা লটটাই যায়।
         *
         * ── ⚠️ তবু পাহারাটা এখানেই ────────────────────────────────────
         * ⓘ পর্দা ঐ লট দেখায় বলে ধরে নেওয়া যায় না যে ওখানে মাল আছে:
         * পর্দা আঁকা হয়েছিল কয়েক মিনিট আগে, আর মাঝখানে **অন্য কাউন্টার**
         * পুরোটা নিয়ে যেতে পারে। ⛔ না দেখলে `floor` ঋণাত্মক হত, আর
         * মজুদের সংখ্যাটা এমন একটা মাল দেখাত যা কোনোদিন ছিলই না।
         *
         * ⓘ বার্তাটা [[BatchAllocator]]-এর ঘাটতির বার্তা নয়, আলাদা —
         * ওখানে "সব লট মিলিয়েও যথেষ্ট নেই", এখানে "**এই** লটে নেই"।
