...
final class RecipeService
{
    ...
    /**
     * এই পণ্যের আর কয়টা বেচা যাবে — কাউন্টারের একমাত্র প্রশ্ন।
     *
     * ── কেন তিন রকম উত্তর ────────────────────────────────────────────
     * **অর্ডারে-রান্না** খাবারের নিজের মজুদ নেই; বিরিয়ানি রান্না হয়
     * অর্ডার পাওয়ার পর। উত্তর আসে উপকরণ থেকে।
     *
     * **হাঁড়ির** খাবার সকালেই রান্না হয়ে গেছে — তখন উপকরণ আর প্রশ্ন
     * নয়, ওগুলো খরচ হয়ে গেছে। উপকরণ ধরে গুনলে যা রান্নাই হয়নি তা
     * বেচা যেত।
     *
     * **বিস্কুট** নিজের মজুদই দেখায়, আর সেই হিসাবটা কলামেই আছে বলে
     * এখানে আবার কোয়েরি করা হয় না।
     *
     * ── কেন এটা এখানে, দুই কন্ট্রোলারে নয় ──────────────────────────
     * POS আর সরাসরি বিক্রয় — দুইটাই একই প্রশ্ন করে, আর দুই জায়গায়
     * লিখলে একদিন একটা বদলাত। ক্যাশিয়ার তখন দুই পর্দায় একই খাবারের
     * পাশে দুইটা সংখ্যা দেখতেন।
     *
     * @param  string  $ownStock  পণ্যের নিজের বিক্রয়যোগ্য মজুদ — কলাম
     *                            থেকে হিসাব করা, তাই আবার চাওয়া হয় না
     */
    public function sellableQty(Product $product, string $ownStock, ?Warehouse $warehouse = null): string
    {
        if (! $this->consumesOnSale($product)) {
            return $ownStock;
        }

        $recipe = $this->forProduct($product);

        return $recipe === null
            ? $ownStock
            : $this->portionsPossible($recipe, $warehouse)['portions'];
    }
