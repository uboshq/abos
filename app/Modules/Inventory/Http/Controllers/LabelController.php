...
class LabelController extends Controller implements HasMiddleware
{
    ...
    /**
     * ⛔ পাতা ভাগ নেই, ইচ্ছাকৃত — এটা বাছাই, তালিকা নয়।
     *
     * প্রতিটা সারির পাশে একটা টিক-ঘর, আর নিচে একটাই "ছাপুন"। পাতা ভাগ
     * করলে কেউ প্রথম পাতায় বারোটা পণ্য টিক দিয়ে পরের পাতায় গেলে ওই
     * বারোটা টিক **নীরবে চলে যেত** — পর্দায় কোনো চিহ্ন থাকত না, আর
     * ছাপা বেরোত কম। ঠিক সেই নীরব ক্ষতি, যেটা ঠেকাতে বাকি পর্দাগুলোয়
     * পাতা ভাগ বসানো হয়েছে।
     *
     * ⓘ উপরের গোনাটাও (`chosen + '/' + মোট`) পুরো তালিকার উপর দাঁড়ানো।
     *
     * ক্যাটালগ বড় হলে উত্তরটা পাতা ভাগ নয় — খোঁজা ও ছাঁকনি, যাতে
     * একজন অল্প কয়েকটা পণ্য পর্দায় এনে একবারেই টিক দিয়ে ছাপতে পারেন।
     *
