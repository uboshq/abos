...
class CapitalEntryPolicy
{
    ...
    {
        return $user->can('finance.capital.create');
    }

    public function update(User $user, CapitalEntry $document): bool
    {
        return $user->can('finance.capital.create');
    }

    public function delete(User $user, CapitalEntry $document): bool
    {
        return $user->can('finance.capital.delete');
    }
}
