...
class RentalContractPolicy
{
    ...
    {
        return $user->can('finance.rental.create');
    }

    public function update(User $user, RentalContract $document): bool
    {
        return $user->can('finance.rental.create');
    }

    public function delete(User $user, RentalContract $document): bool
    {
        return $user->can('finance.rental.close');
    }
}
