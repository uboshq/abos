...
class BankFacilityPolicy
{
    ...
    {
        return $user->can('finance.bank_facility.create');
    }

    public function update(User $user, BankFacility $document): bool
    {
        return $user->can('finance.bank_facility.create');
    }

    public function delete(User $user, BankFacility $document): bool
    {
        return $user->can('finance.bank_facility.close');
    }
}
