...
class DepositPolicy
{
    ...
    {
        return $user->can('finance.deposit.create');
    }

    public function update(User $user, Deposit $document): bool
    {
        return $user->can('finance.deposit.create');
    }

    public function delete(User $user, Deposit $document): bool
    {
        return $user->can('finance.deposit.cancel');
    }
}
