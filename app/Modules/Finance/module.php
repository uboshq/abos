    ...
    'menu' => [
        ...
        */
        ...
        'transactions' => [
             ...
             */
            /*
                ⭐ সারির ক্রম — মালিকের নিজের তালিকা, ১৮ সেপ্টেম্বর ২০২৬।

                তিনি পর্দার ছবিতে বারটা মার্ক করে ক্রমটা লিখে দিলেন:

                    ড্যাশবোর্ড · মাস্টার · ব্যাংক ঋণ · হাতধার ·
                    ব্যাংক আমানত · সঞ্চয়পত্র · বন্ড ·
                    ভাড়ার চুক্তি ও জামানত · আয়

                ⓘ প্রথম দুইটা আলাদা দলের (ড্যাশবোর্ড ও মাস্টার), আর
                ওদের জায়গা কোর ঠিক করে — সব মডিউলে এক। বাকি সাতটা
                এই দলের, আর ওদের ক্রম এখানে লেখা ক্রমই।

                ── ⛔ আগে কী ছিল, আর কেন বদলাল ─────────────────────
                আগে ছিল: ভাড়া · আয় · আমানত তিনটা · হাতধার · ব্যাংক ঋণ।
                ⓘ ক্রমটা গড়ে উঠেছিল যে সারি যেদিন লেখা হয়েছে সেই দিন
                ধরে, কোনো সিদ্ধান্ত ধরে নয়।

                ⭐ মালিকের ক্রমটার নিজের যুক্তি আছে: আগে **যা ফেরত
                দিতে হবে** (ব্যাংক ঋণ, হাতধার), তারপর **যা ফেরত পাব**
                (আমানত তিনটা), তারপর **চুক্তি**, আর শেষে **আয়**।
                ⚠️ টাকার দায় আগে, সম্পদ পরে — খাতা যে ক্রমে পড়া হয়।
            */

            /*
             * ব্যাংক ঋণ — মালিকের ক্রমে প্রথম।
             *
             * ⓘ হাতধারের ঠিক পাশে, আর সেটা ইচ্ছাকৃত: দুইটাই "ফেরত
             * দিতে হবে", তাই মানুষ পাশাপাশি খোঁজেন। ⚠️ কিন্তু এক
            ...
            /*
             * হাতধার — ব্যাংক ঋণ থেকে সম্পূর্ণ আলাদা, মালিকের নির্দেশে।
             *
             * ঋণের সারিটা হিসাব মডিউলে থাকে, আর সেটা ব্যাংকের ঋণের
             * জন্য — কাগজ, কিস্তি, সুদ। এটা তার কিছুই নয়।
             */
            ...
            /*
             * ভাড়ার চুক্তি ও জামানত — আমানতের পরে, আয়ের আগে।
             *
             * ⓘ জামানতের টাকাটাও ফেরতযোগ্য, তাই আমানতের পাশেই মানায়;
             * আর চুক্তিটা নিজেই একটা কাগজ, রোজকার লেনদেন নয়।
             */
            ['label' => 'finance::menu.rental', 'icon' => 'building', 'route' => 'finance.rental.index',
                'permission' => 'finance.rental.view'],

            /*
             * আয় — মালিকের ক্রমে সবার শেষে।
             *
             * ডিপোতে একটা প্রশ্ন আছে যা আর কোথাও নেই — কতটা এল
