...
return [
     ...
     */
    /*
     * ⭐ সিস্টেমের ভাগে, প্রশাসনের **উপরে** — মালিকের সিদ্ধান্ত,
     * ৫ সেপ্টেম্বর ২০২৬: *"উপরের মাস্টার ডাটা সিস্টেমের উপরে নিয়ে আসো।"*
     *
     * ── কেন সরল, আর যুক্তিটা তাঁর ────────────────────────────────────
     * মাস্টার ডাটা রোজকার কাজ নয় — একবার বসিয়ে বছরের পর বছর ছোঁয়া হয়
     * না, ঠিক সিস্টেম প্রশাসনের মতোই। ⓘ উপরে থাকায় সে রোজ চোখে পড়ত আর
     * নিচের রোজকার মডিউলগুলোকে এক ধাপ নামিয়ে দিত।
     *
     * ⚠️ `order` ৫ — সিস্টেম প্রশাসনের (১০) আগে, ব্যাকআপের (২০) আগে।
     * ⓘ ফাঁক রেখে গোনা হয় যাতে পরে মাঝখানে কিছু বসাতে হলে সবগুলো
     * আবার লিখতে না হয়।
     *
     * ⓘ `top` ভাগটা রয়ে গেল, কিন্তু এখন খালি — ওটার নিজের কোনো শিরোনাম
     * নেই, তাই সাইডবারে কিছুই বদলায় না।
     */
    'nav' => ['section' => 'system', 'order' => 5],
     ...
     */
    'form_choices' => [
        \App\Modules\MasterData\Services\MasterListsOnTheVoucherForm::class,
    ],
