 ...
 * সরায়)। জেনেশুনে দুইজন রাখতে হলে যেকোনো পর্দা থেকেই (২১ সেপ্টেম্বর ২০২৬), যেখানে
    ...
    public function resolve(array &$data): ?int
    {
        ...
        $person = $this->lists->create(
            ...
            [
                ...
                /*
                 * ⭐ "এটা আলাদা প্রতিষ্ঠান" টিকটা সাথে যায় — ২১ সেপ্টেম্বর ২০২৬।
                 *
                 * ── ⛔ মালিক যেখানে আটকে গিয়েছিলেন ──────────────────
                 * নাম মিললে [[DuplicationEngine]] থামে আর বলে *"সত্যিই
                 * আলাদা প্রতিষ্ঠান হলে ঘরটা টিক দিয়ে আবার সংরক্ষণ
                 * করুন"*। ⚠️ কিন্তু এই পথে টিকটা **কোনোদিন পৌঁছাত না**:
                 * এখানে একটা নতুন অ্যারে গড়া হত আর `allow_duplicate`
                 * পিছনে পড়ে থাকত।
                 *
                 * ⛔ ফল সবচেয়ে খারাপ ধরনের: ব্যবস্থাটা একটা **করণীয়**
                 * বলত যা করা যেত না। থামা আর দরজা বন্ধ করা তখন এক
                 * জিনিস হয়ে যায়, আর ব্যবহারকারীর হাতে কোনো পথ থাকে না।
                 *
                 * ⓘ ডিফল্ট `false`, তাই যে পর্দা টিকটা পাঠায় না তার
                 * আচরণ এক চুলও বদলায়নি — সেখানে আগের মতোই থামবে।
                 */
