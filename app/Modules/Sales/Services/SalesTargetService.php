...
final class SalesTargetService
{
     ...
     * রোলের নাম কোম্পানিভেদে আলাদা হতে পারে — কেউ "salesman" না লিখে
     * "মাঠকর্মী" বানান। নাম ধরে খুঁজলে ওই ডিপোতে তালিকাটা খালি আসত।
     * প্রশ্নটা আসলে "কে বিল কাটতে পারেন", আর ওটার উত্তর অনুমতিতে।
     *
     * ── ⛔ কিন্তু অনুমতিই একমাত্র ছাঁকনি ছিল (৬ সেপ্টেম্বর ২০২৬) ──────
     * `User`-এ কোম্পানির গ্লোবাল স্কোপ **নেই**, আর থাকার কথাও নয় —
     * একজন মানুষ একাধিক কোম্পানিতে কাজ করতে পারেন। তাই ছাঁকনিটা হাতে
     * বসাতে হয়, আর এখানে বসানো হয়নি।
     *
     * ⚠️ ফল মেপে দেখা হয়েছে: কোম্পানি ৪৬-এ দাঁড়িয়ে টার্গেটের
     * স্কোরবোর্ডে **কোম্পানি ৪৫-এর বিক্রয়কর্মী** দেখা যেত। আর তালিকাই
     * শুধু নয় — [[setForMonth()]] এই তালিকাটাই ধরে, অর্থাৎ **অন্য
     * কোম্পানির কর্মীর নামে টার্গেটও বসানো যেত**।
     *
     * ⓘ ছাঁচটা নতুন নয়, রিপোতে পাঁচ জায়গায় আগে থেকেই ঠিক লেখা আছে —
     * [[CashTillController]] · [[MoneyTransferController]] ·
     * [[LocationController]] · [[CounterApproval]] ·
     * [[ApprovalFlowController]]। এখানে সেই একটা লাইনই বাদ ছিল।
     *
