...
return [
    ...
    /*
     * ⭐ কার্টের সারি সম্পাদনা — ২৫ সেপ্টেম্বর ২০২৬।
     *
     * ⓘ লেখাটা *"সম্পাদনা"* নয়, *"উপরে নিন"* — কারণ চাপলে সারিটা
     * এখানেই বদলায় না, **এন্ট্রির বাক্সে ফিরে যায়**। ⚠️ *"সম্পাদনা"*
     * লিখলে মানুষ ঐ ঘরেই টাইপ করার অপেক্ষা করতেন।
     */
    'edit_line' => 'উপরে নিয়ে বদলান',
     ...
     */
    /*
     * ⭐ খসড়া রাখার বোতাম — মালিকের নির্দেশ, ২৫ সেপ্টেম্বর ২০২৬।
     *
     * ⓘ লেখাটা ক্রিয়া — চাপলে একটা কাজ ঘটে। ⚠️ শুধু "খসড়া"
     * লিখলে পড়ে বোঝা যেত না সেটা অবস্থা না আদেশ — পাশেই
     * নিশ্চিত করুন বসে, আর দুইটাই ক্রিয়া হলে পার্থক্যটা স্পষ্ট।
     */
    'save_draft' => 'খসড়া রাখুন',
