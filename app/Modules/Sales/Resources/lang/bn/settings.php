...
return [
    'receipt_needs_order' => 'আদেশ ছাড়া মাল নেওয়া যাবে না',
    ...
    'screen_pos' => 'কাউন্টার (POS) পর্দা দেখাও',
    'screen_direct' => 'সরাসরি বিক্রয়ের পর্দা দেখাও',
    'screen_orders' => 'বিক্রয় আদেশের পর্দা দেখাও',
    'screen_challans' => 'ডেলিভারি চালানের পর্দা দেখাও',
    'reprint_limit' => 'একটা কাগজ সর্বোচ্চ কতবার ছাপা যাবে (০ = সীমা নেই)',
    'screen_shipments' => 'শিপমেন্টের পর্দা দেখাও',

    // ডিলারের কমিশন — কোম্পানির কাছে দাবি
    'commission_max_amount' => 'কমিশনের সর্বোচ্চ টাকা (০ = সীমা নেই)',
    'rounding_max' => 'রাউন্ডিং সর্বোচ্চ কত টাকা (০ = সীমা নেই)',
    ...
    'paper_invoice' => 'বিক্রয় বিল কোন কাগজে',
    'paper_challan' => 'ডেলিভারি চালান কোন কাগজে',
    'paper_order' => 'বিক্রয় আদেশ কোন কাগজে',
    'paper_receipt' => 'আদায়ের রসিদ কোন কাগজে',
];
