...
class PosController extends Controller implements HasMiddleware
{
    ...
    /**
     * ⛔ পাতা ভাগ নেই, ইচ্ছাকৃত — এটা কাউন্টার, তালিকার পর্দা নয়।
     *
     * এখানে যা যায় তার কোনোটাই "দেখার তালিকা" নয়: পণ্য, গ্রাহক, গুদাম
     * আর টাকার উপায় — সবগুলোই **বাছার ঘর**, আর কার্টটা একটাই ফর্ম।
     * পাতা ভাগ করলে ক্যাশিয়ার অর্ধেক বিল ভরে পরের পাতায় গেলে কার্ট
     * হারাত, আর তার সামনে লাইনে মানুষ দাঁড়িয়ে থাকত।
     *
     * ⓘ ক্যাটালগের সীমা আগে থেকেই আছে, আর সেটা পাতা ভাগ নয়:
     * `INLINE_CATALOGUE_LIMIT` — পর্দায় যতটা ধরে ততটাই আসে, বাকিটা
     * খোঁজার ঘর দিয়ে। বড় ক্যাটালগের ঠিক উত্তরটা ওটাই, কারণ কাউন্টারে
     * কেউ পণ্য খুঁজতে পাতা ওল্টান না, বারকোড মারেন বা নাম লেখেন।
     *
