            ...
            function directPurchase(catalogue, vatEnabled, lastRatesUrl) {
                return {
                    ...
                    suppliers: @js($suppliers->map(fn ($s) => [
                         ...
                         *
                         * ⚠️ আগে যেত কেবল `name()`, অর্থাৎ চলতি ভাষার নামটা।
                         * ⓘ বাংলা লোকেলে ইংরেজি নামটা ব্রাউজারে পৌঁছাতই না,
                         * তাই `Bengal` লিখে `বেঙ্গল ফুডস লিমিটেড` মিলত না —
                         * আর পর্দা বলত **"ওই নামে কোনো সরবরাহকারী নেই"**।
                         *
                         * ⛔ মিথ্যা বার্তাটাই সবচেয়ে খারাপ অংশ: মানুষ তখন
                         * একই সরবরাহকারী দ্বিতীয়বার বসান, আর বকেয়া দুই
                         * সারিতে ভাগ হয়ে যায়।
                         */
