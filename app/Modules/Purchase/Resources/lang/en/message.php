...
return [
    ...
    'bill_from_receipt' => 'Made automatically from goods receipt :no',
    'auto_bill_made' => 'Bill :no was made and confirmed at the receipt rates. If the supplier\'s bill differs in price or discount, open the bill and edit it.',
    'auto_bill_held' => 'Bill :no was made and is waiting for approval.',
    'auto_bill_draft' => 'Bill :no is still a draft — :why Fix it and confirm it from the bill page.',
    'auto_bill_failed' => 'No bill was made — :why Try again with the "Bill the rest" button on this page.',
    'auto_bill_nothing_left' => 'Everything on this receipt has already been billed.',
    ...
    'payment_unallocated' => 'Not split across any bill — it stays on the supplier account and comes off the next bill.',
    ...
    'paid_more_confirm' => 'This pays more than the invoice. The extra stays on the supplier account and comes off the next bill. Continue?',
    ...
    'requisition_note' => 'Say what is needed and roughly what it costs. Who to buy it from is the buying department\'s call, not this paper\'s.',
    'requisition_created' => 'The requisition is saved. Nothing is committed yet.',
    'requisition_approved' => 'The requisition is approved and an order can be made from it.',
    'requisition_ordered' => 'Requisition :no is now a purchase order.',
    'requisition_cancelled' => 'The requisition is cancelled.',
    'requisition_approve_note' => 'Approving does not buy anything. It says the money may be spent.',
    'requisition_order_note' => 'Rates are not carried over - the estimate was a guess. Put the real rates on the order.',
    'order_from_requisition' => 'From requisition :no',
    'no_rfqs' => 'No requests yet.',
    'rfq_note' => 'Say what you want and who to ask. Rates are what you are asking for - do not put your own guess in.',
    'rfq_ask_note' => 'Tick everyone you will ask. Who you asked is kept even if they never answer - that silence is a fact too.',
    'rfq_no_suppliers' => 'There are no suppliers to ask yet.',
    'rfq_created' => 'The request is saved. Nothing has gone out yet.',
    'rfq_sent' => 'The request has gone out. The supplier list is fixed now.',
    'rfq_send_note' => 'After sending, the products and the supplier list cannot change - otherwise the record of who was asked would be false.',
    'no_quotations_yet' => 'Nobody has answered yet.',
    'quotation_saved' => 'The quotation is recorded.',
    'rfq_silent_note' => 'These suppliers were asked and have not answered. This is the list to chase.',
    'everyone_has_answered' => 'Everyone who was asked has answered.',
    'rfq_from_requisition' => 'From requisition :no',
    'no_contracts' => 'No contracts yet.',
    'contract_note' => 'The rate agreed at the start of the year. Every order will be measured against it.',
    'contract_limit_note' => 'Leave a limit empty if there is none. Some contracts cap the quantity, some cap the money, some neither.',
    'contract_created' => 'The contract is saved as a draft. It binds nothing yet.',
    'contract_activated' => 'The contract is live. Orders are measured against these rates now.',
    'contract_activate_note' => 'Making it live turns these rates into the company\'s word. Draft rates bind nothing.',
];
