...
return [
    ...
    'role_templates' => [
        /*
         * ⭐ চাওয়া গুদামের, সিদ্ধান্ত ব্যবস্থাপকের — ২৫ সেপ্টেম্বর ২০২৬।
         *
         * ── ⛔ কেন এই সারিগুলো লাগল ──────────────────────────────────
         * চাহিদা, দরপত্র ও চুক্তির আটটা চাবি ২৪ সেপ্টেম্বরে ঘোষিত হয়েছিল,
         * কিন্তু কোনো ভূমিকায় বসেনি। ⚠️ ফলে ওগুলো ছিল কেবল
         * `Permission::all()`-এর জোরে **মালিকের হাতে**, আর কেউ ঢালাও
         * নিয়মেও পেত না (`purchase.%` বলে কোনো নিয়ম নেই — মেপে দেখা)।
         *
         * ⛔ অর্থাৎ পর্দা দুইটা চালু করার পরেও কর্মীদের মেনুতে সারিগুলো
         * আসত না, আর মালিক দেখতেন সব ঠিক — কারণ তাঁর কাছে সব চাবিই আছে।
         * ⓘ ঠিক এই আকারের ফাঁক [[Inventory/module.php]]-এ একবার ধরা
         * পড়েছিল: *"গুদামের লোক রোজ সকালে মালিককে ডেকে আনতেন"*।
         */

        /*
         * ⭐ চাহিদা লেখেন যিনি অভাবটা দেখেন।
         *
         * ⓘ তাক খালি হতে দেখেন গুদামের লোক, ক্রয় বিভাগ নয় — আর
         * চাহিদাপত্রের গোটা কারণই সেটা: যিনি চান আর যিনি কেনেন দুইজন
         * আলাদা মানুষ।
         *
         * ⛔ `approve` এখানে **নেই**, ইচ্ছাকৃতভাবে: নিজের চাওয়া নিজে
         * মঞ্জুর করতে পারলে অনুমোদনের ধাপটার কোনো মানেই থাকে না।
         * ⓘ নিয়মটার নিজের পাহারা আছে
         * ([[ThePersonWhoNeededItHadNoWayToAskTest]]), কিন্তু পাহারাটা
        ...
        'Manager' => [
            ...
            /*
             * ⓘ ব্যবস্থাপক চাহিদা **দেখেন ও মঞ্জুর করেন** — লেখেন না।
             * ⚠️ লেখার চাবিটা দিলে তিনি নিজের চাওয়া নিজেই মঞ্জুর করতে
             * পারতেন, আর দুই হাতের নিয়মটা ভূমিকার স্তরেই ভেঙে যেত।
             */
            'purchase.requisition.view', 'purchase.requisition.approve',

            /*
             * ⓘ দরপত্র ডাকা দরাদরির কাজ, আর দরাদরি ব্যবস্থাপকের।
             * ⚠️ গুদামের লোককে দিলে তিনি সরবরাহকারীর সাথে দর নিয়ে
             * কথা বলতে বাধ্য হতেন — ওটা তাঁর কাজ নয়, আর তাঁর দর
             * জানারও কথা নয়।
             */
            'purchase.rfq.view', 'purchase.rfq.create',

            /*
             * ⛔ চুক্তি লেখা আর চালু করা দুইটা আলাদা চাবি, আর দুইটাই
             * ব্যবস্থাপকের — ⓘ কারণ চালু করা মানে ঐ দরটাকে
             * **প্রতিষ্ঠানের কথা** বানিয়ে দেওয়া, আর সেটা একটা
             * বাণিজ্যিক সিদ্ধান্ত।
             *
             * ⚠️ দুইটা আলাদা থাকার মানে তবু হারায় না: চালু করা এখনো
             * একটা আলাদা ধাপ, আর সেটাই আসল পাহারা
             * ([[PurchaseContractPolicy::activate()]])।
             */
            'purchase.contract.view', 'purchase.contract.create',
            'purchase.contract.activate',
        ],
    ],
