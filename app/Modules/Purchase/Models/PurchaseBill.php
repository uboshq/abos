...
class PurchaseBill extends Model implements Drillable
{
    ...
    protected $fillable = [
         ...
         *
         * Eloquent-এর নিয়ম: `$fillable`-এ না থাকা চাবি `create()` ফেলে
         * দেয়। পর্দা ঠিক, যাচাই ঠিক, মাইগ্রেশন ঠিক — তবু ভাড়ার ঘরটা
         * শূন্য থেকে যেত।
         *
         * ⚠️ এখানে আগে লেখা ছিল ওটা **নীরবে** ঘটে। **এই রিপোতে সেটা
         * ভুল, আর আমি যাচাই না করে লিখেছিলাম** —
         * [[AppServiceProvider]] `preventSilentlyDiscardingAttributes()`
         * চালু রাখে `local` ও `testing`-এ, তাই এখানে ওটা **ব্যতিক্রম
         * ছোড়ে**।
         *
         * ⭐ অর্থাৎ ভুলটা ধরা পড়ে উন্নয়নে ও পরীক্ষায়, ক্রেতার খাতায় নয়
         * — নীরব থাকে কেবল লাইভে, যেখানে সুইচটা ইচ্ছে করেই বন্ধ (একটা
         * বাড়তি চাবি যেন গোটা পাতা না ভাঙে)।
         *
         * ⓘ তবু ঘরগুলো এখানে লেখা থাকা দরকার: ষষ্ঠ ঘর যোগ করার দিন
         * কেউ আবার ভুলবেন, আর তখন লাল টেস্টটাই একমাত্র খবর।
         */
