 ...
 * **[[self::SCREENS_USING_ALPINE]]টা ব্লেড ফাইলে `x-data`** — Alpine
 ...
 * এখানে হাতে লেখা ছিল **৭২**। ⚠️ ১৮ সেপ্টেম্বর ২০২৬-এ গুনে দেখা গেল
 * সংখ্যাটা **৮৬** — অর্থাৎ সিদ্ধান্তটা যে মাপের উপর দাঁড়িয়ে ছিল, সেই
 * মাপটাই আর সত্যি ছিল না, আর কেউ জানত না।
 *
...
{
    /**
     * কতগুলো ব্লেড ফাইল এখনো `x-data` ব্যবহার করে — অর্থাৎ `unsafe-eval`-এর দাম।
     *
     * ⓘ এটা লক্ষ্য নয়, **ঋণের হিসাব**। ⭐ সংখ্যাটা শূন্য হলে
     * `unsafe-eval` তুলে দেওয়া যাবে, আর তার আগে নয়।
     *
     * ⚠️ বদলালে এখানে বদলান — [[TheReasonWeStillAllowEvalTest]] গুনে
     * মিলিয়ে দেখে, তাই ভুলে যাওয়ার উপায় নেই।
     */
    public const SCREENS_USING_ALPINE = 86;
