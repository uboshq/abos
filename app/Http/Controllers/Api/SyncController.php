...
class SyncController extends Controller
{
    ...
    public function push(Request $request, string $module): JsonResponse
    {
         ...
         * `changes` অ্যারেটাই পাঠায়।
         *
         * ── ⛔ কেন `all()` নয়, `json()->all()` — ১৫ সেপ্টেম্বর ২০২৬ ──
         * `$request->all()` **শরীর আর query string একসাথে** দেয়
         * (`getInputSource()->all() + $this->query->all()`)। আর এই
         * দরজায় query-তে সবসময় `?deviceId=` থাকে, কারণ চুক্তির §২
         * সেটা বাধ্যতামূলক করেছে।
         *
         * ⚠️ ফল: শরীর `[0 => {…}]` আর query `['deviceId' => '…']` মিলে
         * হত `[0 => {…}, 'deviceId' => '…']` — যা আর **তালিকা নয়**।
         * নিচের পাহারাটা তখন ৪২২ দিত।
         *
         * ⛔ অর্থাৎ **নিয়ম মেনে চললেই ব্যর্থ** — ফোন যত সঠিকভাবে ডাকত,
         * তত নিশ্চিতভাবে ৪২২ পেত। আর ব্যর্থতাটা নীরব: কিউতে সারিটা
         * "অপেক্ষমাণ" থেকে যেত, কোনো লাল বার্তা নেই। ⓘ সেলসম্যান
         * ভাবতেন নেট নেই।
         *
         * ⭐ ধরা পড়েছে লাইভে, আসল ফোন থেকে — কোনো সার্ভার-সাইড পরীক্ষা
         * এটা ধরেনি, কারণ পরীক্ষাগুলো query প্যারামিটার ছাড়া ডাকত।
         * [[TheSyncPushNeverWorkedForARealPhoneTest]] এখন সেটাই ধরে।
         */
