...
| **চেক রেজিস্টার** | `instrument` ঘরটা জমা থাকত, **একটাও দাখিলা বদলাত না** — হাতে আসা চেক সাথে সাথেই ব্যাংকের টাকা হয়ে যেত | ১৩ |
...
|---|---|
| ২ | কস্ট সেন্টার |
| ৩ | নিজের অনুমোদনের নিয়ম + একজনের ব্যতিক্রম |
| ৪ | ব্যাংক মিলকরণ |
| ৫ | নকল ঠেকানো |
| ৬ | বিজ্ঞপ্তি |
