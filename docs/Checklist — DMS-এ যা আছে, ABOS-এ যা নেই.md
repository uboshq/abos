...
| **`core/theme`** | 🟡 **আটটা রূপ চলছে, ইঞ্জিন নেই** | রূপগুলো একটা CSS ফাইলে (৩৫KB, ৪৭২ টোকেন)। প্রত্যেকে আটটাই নামান, ব্যবহার করেন একটা। কোম্পানির নিজের রূপ সম্ভব নয়, নতুন রূপে ডিপ্লয় লাগে, আর ভুল টোকেন সেভের সময় ধরা পড়ে না। মালিকের সিদ্ধান্ত ২১ আগস্ট: **আলাদা ও বড় ইঞ্জিন হবে** — `docs/Plan — Theme Engine.md` |
...
| ১১ | **থিম ইঞ্জিন — ধাপ ১** · রেজিস্ট্রি · সংকলক · স্কিমা · গাঢ় রূপ | আটটা রূপ ডাটায় সরে; পাতায় কেবল চলতিটা নামে; ভুল টোকেন সেভের সময় ফেরে। **প্রমাণ:** ইঞ্জিনের পরেও ব্রাউজারে ওই একই ৮৭টা মান মিলতে হবে, একটাও পিক্সেল না নড়ে |
