        ...
        <form method="POST" action="{{ route('profile.update') }}" class="space-y-4">
            ...
            <section data-boxed class="rounded-(--radius-card) border border-(--color-border) bg-(--color-surface-card) p-4">
                ...
                <div class="grid gap-3 sm:grid-cols-2">
                    ...
                    {{-- ⭐ ব্যবহারকারী আইডি — মালিকের নির্দেশ, ১৪ সেপ্টেম্বর ২০২৬।

                         ⓘ `public_id`, সারির `id` নয়: ভেতরের সংখ্যাটা
                         (১, ২, ৩) কোম্পানি বদলালে বা ডেটা সরালে অর্থ
                         হারায়, আর ওটা বাইরে বলা মানে কতজন ব্যবহারকারী
                         আছেন তাও বলে দেওয়া।

                         ⚠️ `readonly`, `disabled` নয় — ⛔ নিষ্ক্রিয় ঘরের
                         লেখা অনেক ব্রাউজারে **বাছাই করা যায় না**, অর্থাৎ
                         কপিও করা যায় না। আর এই সংখ্যাটার একমাত্র কাজই
                         হলো সহায়তার সময় কাউকে বলা। --}}
                    <label class="block">
                        <span class="mb-1 block text-sm font-medium">{{ __('core.profile.user_id') }}</span>
                        <input type="text" value="{{ $user->public_id }}" readonly
                               onfocus="this.select()"
                               class="{{ $fieldReadOnly }} font-mono text-xs">
                    </label>
