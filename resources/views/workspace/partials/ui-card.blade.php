...
<label class="group flex cursor-pointer select-none flex-col gap-2 rounded-(--radius-card)
    ...
    {{--
        ক্লিক করলেই বসে যায় — আলাদা করে সংরক্ষণ টিপতে হয় না।

        ── কেন, ২৯ আগস্ট ২০২৬ ──────────────────────────────────────
        মালিক বারবার বলেছেন "থিম বদলায় না", আর আমি প্রতিবার মেপে
        দেখেছি সার্ভারে বদলায়। দুইজনেই ঠিক ছিলাম, কারণ প্রশ্নটাই
        আলাদা ছিল।

        তিনি Ava দেখিয়ে বললেন ওখানে কত মসৃণভাবে বদলায়। Ava-তে
        থিমের ঘরে ক্লিক করলেই ফর্মটা নিজে চলে যায় — একটা ক্লিক, আর
        পর্দা বদলে যায়।

        ABOS-এ ছিল দুই ধাপ: কার্ডে ক্লিক, তারপর নিচে নেমে সংরক্ষণ।
        কার্ডে ক্লিকের পর কেবল বর্ডারটা বদলাত, আর যিনি সংরক্ষণ
        বোতামটা খুঁজে পাননি তাঁর কাছে "কিছুই হয়নি" — অর্থাৎ থিম
        বদলায় না। কথাটা আক্ষরিক অর্থেই সত্যি ছিল, কেবল কারণটা
        সার্ভারে ছিল না, ওই দ্বিতীয় ধাপটায় ছিল।

        `requestSubmit()`, `submit()` নয় — ওটা ফর্মের যাচাই ও
