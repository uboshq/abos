...
<header class="topbar sticky top-0 z-30 flex h-(--spacing-header) shrink-0 items-center gap-2
    ...
    <div class="ms-auto flex items-center gap-1">
        ...
        {{--
            ...
            ── কেন `xl`, `lg` নয় ────────────────────────────────────
            প্রথমে `lg` (১০২৪px) বসানো হয়েছিল, আর ঠিক ১০২৪-এ বারটা
            **৪px** উপচে পড়ত — বোতাম দুইটা ওখানেই ফিরে আসে, আর
            জায়গাটা ঠিক ততটুকুই কম পড়ে।

            ১২৮০ প্রকল্পের ঘোষিত চারটা প্রস্থের একটা (৩৭৫·৭৬৮·১২৮০·
            ১৯২০), তাই সীমাটা ওখানেই — একটা মাঝামাঝি সংখ্যা বেছে
            নেওয়ার চেয়ে ঘোষিত মাপ ধরাই টেকে।
        --}}
        <form method="POST" action="{{ route('locale.switch') }}" class="hidden xl:contents">
            @csrf
