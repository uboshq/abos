...
<aside x-data="{ filter: '' }"
    ...
    <div class="flex min-w-0 flex-1 flex-col">
        ...
        {{-- ⛔ ওয়ার্ডমার্ক ও সোনালি স্লোগান-ফিতা এখানে ছিল — মালিকের
             নির্দেশে তোলা হলো, ১৩ সেপ্টেম্বর ২০২৬।

             ── কী ছিল ──────────────────────────────────────────────
             রেলের টাইলের ঠিক পাশে একটা দ্বিতীয় লিংক, তার ভিতরে পুরো
             চওড়ার `abos` ওয়ার্ডমার্ক আর তার নিচে সোনালি ফিতায়
             "SIMPLE TO RUN. POWERFUL TO GROW"।

             ── ⓘ যা রয়ে গেল, আর কেন ─────────────────────────────────
             বাঁ রেলের চিহ্ন-টাইলটা (`abos-icon`) আছে — মালিক ওটা
             চিহ্নিত করেননি, আর ওটাই দুই অবস্থাতে (খোলা ও গুটানো)
             ড্যাশবোর্ডে ফেরার পথ। ⚠️ টাইলের লিংকটার নাম আসে তার
             `title` থেকে ("ড্যাশবোর্ড"), তাই এখানকার `sr-only`
             নামটা চলে যাওয়ায় লিংকটা বেনামি হয়নি।

             ⚠️ ব্র্যান্ডের নামটা পর্দা থেকে হারায়নি: ফুটারের বাঁ কোণে
             ওয়ার্ডমার্কটা বসে (`shell/statusbar`), আর সেখানে তার
             `alt`-এ নামটা লেখা। --}}
        </div>
