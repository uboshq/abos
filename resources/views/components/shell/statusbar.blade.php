...
<footer class="fixed inset-x-0 bottom-0 z-20 hidden h-(--spacing-status-bar) items-center gap-4
    ...
    {{-- ব্যবহারকারীর নাম গাঢ় — বারের বাকি সব ফিকে, আর "আমি কে হয়ে বসে
         আছি" প্রশ্নটা সবচেয়ে বেশি জিজ্ঞেস করা হয়। একই ফিকে রঙে থাকলে
         চোখ ওটার উপর দিয়ে চলে যেত। ডিপোতে একটা কম্পিউটার কয়েকজন ভাগ
         করে ব্যবহার করেন, তাই প্রশ্নটা আরও ঘন ঘন আসে। --}}
    <span class="shrink-0 font-semibold text-(--color-ink)">{{ $user?->name }}</span>
