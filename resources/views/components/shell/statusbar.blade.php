...
<footer data-footer class="fixed inset-x-0 bottom-0 z-20 hidden h-(--spacing-status-bar) items-center gap-4
    ...
    {{-- ⭐ অর্থবছর বাঁ দিকে, "সচল"-এর ঠিক পরে — মালিকের নির্দেশ,
         ৫ সেপ্টেম্বর ২০২৬:

             বাঁয়ে >> সচল  অর্থবছর: 2026-2027
             ডানে  >> © 2026 ABOS  Powered by: UNIVER BANGLADESH  v0.1.0

         ⓘ দুইটাই **এই মুহূর্তের অবস্থা** — সিস্টেম চলছে, আর কোন বছরের
         খাতায় লেখা হচ্ছে। ⚠️ আগে অর্থবছর ডানে বসত, নির্মাতার নাম ও
         সংস্করণের মাঝখানে; অর্থাৎ **একটা কাজের তথ্য দুইটা পরিচয়ের
         তথ্যের ভিড়ে** হারিয়ে যেত।

         ⚠️ ব্যাক-ডেটেড এন্ট্রি আটকাতে গিয়ে কেউ যখন ভাবেন "কোন বছরে
         আছি", তখন চোখ বাঁ দিক থেকে পড়া শুরু করে — ডান কোণ নয়। --}}
    @if ($year)
    ...
    {{-- ⭐ ডান কোণের তিনটা একসাথে — মালিকের ক্রম, ৫ সেপ্টেম্বর ২০২৬:
         *"© 2026 ABOS  Powered by: UNIVER BANGLADESH  v0.1.0"*।

         ⓘ তিনটাই **পরিচয়ের তথ্য**, অবস্থার নয় — কে বানিয়েছে, কোন
         সংস্করণ। ⚠️ একবার দেখলেই যথেষ্ট, তাই এরা কোণে; বাঁ দিকের
         দুইটা রোজ বদলায়, তাই ওরা চোখের পথে।
