...
<footer data-footer class="fixed inset-x-0 bottom-0 z-20 hidden h-(--spacing-status-bar) items-center gap-4
    ...
    {{-- ⓘ চিহ্ন নয়, **শব্দচিহ্ন** — মালিকের নির্দেশ, ১৩ সেপ্টেম্বর ২০২৬।
         পাশে ABOS নামটা লেখা নেই, তাই ছবিটাকেই নামটা বলতে হয়; গোল
         চিহ্নটা (`abos-icon`) সেটা বলে না, "abos" লেখা শব্দচিহ্নটা বলে।

         ⚠️ `size-5` নয়, `h-4 w-auto` — আর কারণটা মাপের:
         শব্দচিহ্নটা ৫৫৬×১৯৮, অর্থাৎ প্রায় ২.৮:১ চওড়া। ⛔ বর্গাকার
         ক্লাস দিলে `object-contain` ওটাকে ২০px বাক্সে ঢুকিয়ে **২০px
         চওড়া** করে ফেলত, আর ঐ মাপে "abos" লেখাটা পড়াই যেত না।

         ⓘ বার ২৮px উঁচু (`--spacing-status-bar`), তাই ১৬px উচ্চতা
         দুই পাশে শ্বাস রাখে, আর চওড়া দাঁড়ায় ~৪৫px।

         ⓘ `width`/`height` দেওয়া আছে ছবিটা নামার আগেই জায়গাটুকু ধরে
         রাখতে — নাহলে ফুটারের লেখাগুলো এক ঝলক লাফাত। --}}
    <span class="flex shrink-0 items-center gap-1.5">
        <img src="{{ asset('brand/abos-wordmark-transparent.png') }}"
             alt="{{ __('core.brand.name') }}"
             width="556" height="198"
