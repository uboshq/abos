...
/*
 * ⛔ এখানে আরেকটা `taka` ছিল, আর সে বিল্ডটাই ভাঙছিল — ২১ সেপ্টেম্বর ২০২৬।
 *
 * ⓘ কমার নিয়ম এক জায়গায় আনার সময় উপরে `money.js` থেকে `taka`
 * আমদানি করা হয়েছে, কিন্তু এই স্থানীয় সংজ্ঞাটা রয়ে গিয়েছিল —
 * "It can not be redeclared here"।
 *
 * ⚠️ ধরা পড়েছে কেবল `npm run build`-এ। কোনো PHP পরীক্ষা, কোনো JS
 * পরীক্ষা এটা ধরেনি (vitest প্রতিটা মডিউল আলাদা পড়ে, একসাথে বাঁধে
 * না)। ⓘ অর্থাৎ ৮৯/৮৯ সবুজ থাকা অবস্থাতেও **লাইভের জন্য কোনো
 * বান্ডিলই তৈরি হত না**।
 *
 * ⭐ ভাগ-করা `taka` বরং কড়া: সে `maximumFractionDigits`-ও বাঁধে, তাই
 * ১২৩৪.৫৬৭৮ আর তিন দশমিকে ছাপা হয় না।
 */
